...
-- Transformation to translate following commands to Portrait view, direction only
local OrientationDirTransform = {}
OrientationDirTransform[PORTRAIT] = function() end
OrientationDirTransform[PORTRAIT_UPSIDE_DOWN] = function() rotate(180) end
OrientationDirTransform[LANDSCAPE_LEFT] = function() rotate(90) end
OrientationDirTransform[LANDSCAPE_RIGHT] = function() rotate(-90) end

-- Transformation to translate following commands from Portrait view, direction only
local OrientationDirInverseTransform = {}
OrientationDirInverseTransform[PORTRAIT] = function() end
OrientationDirInverseTransform[PORTRAIT_UPSIDE_DOWN] = function() rotate(180) end
OrientationDirInverseTransform[LANDSCAPE_LEFT] = function() rotate(-90) end
OrientationDirInverseTransform[LANDSCAPE_RIGHT] = function() rotate(90) end
...
--[[
Transform direction vector x relative to orientation o into a direction
vector relative to the current orientation.
--]]

function OrientationDir(o,x)
    o = ResolveOrientation(o,CurrentOrientation)
   if CurrentOrientation == o then
      return x
   end
...
--[[
Transform direction vector x relative to the current orientation o into a
direction vector relative to the current orientation.
--]]

function OrientationDirInverse(o,x)
    o = ResolveOrientation(o,CurrentOrientation)
   if CurrentOrientation == o then
      return x
   end
...
function OrientationsDir(o,oo,x)
    o = ResolveOrientation(o,oo)
    oo = ResolveOrientation(oo,o)
   if oo == o then
      return x
...
Apply a transformation to transform the following drawing commands
relative to orientation o into commands relative to the current
orientation, rotations only.
--]]

function TransformDirOrientation(o)
    o = ResolveOrientation(o,CurrentOrientation)
   if CurrentOrientation == o then
      return
   end
   OrientationDirInverseTransform[CurrentOrientation]()
   OrientationDirTransform[o]()
end

--[[
Apply a transformation to transform the following drawing commands
relative to the current orientation into commands relative to the
specified orientation, rotations only.
--]]

function TransformDirInverseOrientation(o)
    o = ResolveOrientation(o,CurrentOrientation)
   if CurrentOrientation == o then
      return
   end
   OrientationDirInverseTransform[o]()
   OrientationDirTransform[CurrentOrientation]()
end

function TransformDirOrientations(o,oo)
    o = ResolveOrientation(o,oo)
    oo = ResolveOrientation(oo,o)
   if oo == o then
      return
...
local exports = {
   ...
   OrientationDirTransform = OrientationDirTransform,
   OrientationDirInverseTransform = OrientationDirInverseTransform,
   ResolveOrientation = ResolveOrientation,
   Orientation = Orientation,
   OrientationInverse = OrientationInverse,
   Orientations = Orientations,
   OrientationDir = OrientationDir,
   OrientationDirInverse = OrientationDirInverse,
   OrientationsDir = OrientationsDir,
   ...
   TransformDirOrientation = TransformDirOrientation,
   TransformDirInverseOrientation = TransformDirInverseOrientation,
   TransformDirOrientations = TransformDirOrientations,
