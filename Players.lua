...
function Players:addTeam(c,n,s,g)
    local t = {name = n, colour = c, size = 0, goal = g, score = 0, active = true, strip = s}
...
function Players:addPlayer(p,v,n,t,s)
    t.size = t.size + 1
    n = n or t.size
    local pl = Player(n,p,v,t,s,self)
